...
const LazyPaymentsPage = lazy(() => import("@/pages/ModernPaymentsPage"));
const LazyReportsPage = lazy(() => import("@/pages/ReportsPage"));
const LazySettingsPage = lazy(() => import("@/pages/SettingsPage"));
const LazyMaintenancePage = lazy(() => import("@/pages/ModernMaintenancePage"));
const LazyStudentsPage = lazy(() => import("@/pages/ModernStudentsPage"));
